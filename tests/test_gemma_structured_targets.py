...
from gitctx import gemma_structured_targets as gt
from test_student_input import record


class GemmaStructuredTargetsTests(TestCase):
    def setUp(self):
    ...
    def api(self, url, payload=None):
        ...
        prompt = '<bos><|turn>system\n' + payload['messages'][0]['content'] + '<turn|>\n<|turn>user\n' + payload['messages'][1]['content'] + '<turn|>\n<|turn>model\n'
