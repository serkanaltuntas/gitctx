"""Native non-thinking Qwen3.5 9B full-source candidates, never automatic labels."""
...
VERSION = 'qwen35-9b-target-candidate-v1'
...
def generate(record, *, tokenizer, student_tokenizer, model, model_digest,
    ...
    response = request_json(base + 'generate', {
        ...
        'options': {'num_ctx': context, 'num_predict': 256, 'temperature': temperature,
